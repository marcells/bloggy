...
exports.load = function (baseDirectory, callback) {
    glob('**/meta.json', { root: baseDirectory }, function (err, results) {
        var metadata = [];
        ...
        results.forEach(function (result) {
            ...
            meta.contentPath = path.resolve(path.join(dir, 'content.md'));
